...
#define LED_ARM_PORT  (GPIOD)
#define LED_ARM_GREEN (GPIO_Pin_12)
#define LED_ARM_RED   (GPIO_Pin_14)
#define LED_ARM_BLUE  (GPIO_Pin_15)
...
#define MODE2 (GPIO_Pin_7)
#define MODE1 (GPIO_Pin_8)
#define MODE0 (GPIO_Pin_9)
