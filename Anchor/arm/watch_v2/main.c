...
{
  // send range to BLE over uart
  ntb_led_toggle(NTB_LED_ARM_BLUE);
  uart_tx_range(timeStats->srcAddr, timeStats->range);
}
...
int main(void)
{
  ...
  dw_spi_configprescaler(SPI_BaudRatePrescaler_8);
