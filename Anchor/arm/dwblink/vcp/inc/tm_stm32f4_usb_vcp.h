...
#include "usbd_cdc_vcp.h"
 ...
 // More friendly defines for API
 #define usb_vcp_init TM_USB_VCP_Init
 #define usb_vcp_getstatus TM_USB_VCP_GetStatus
 #define usb_vcp_getc TM_USB_VCP_Getc
 #define usb_vcp_putc TM_USB_VCP_Putc
 #define USB_VCP_CONNECTED TM_USB_VCP_CONNECTED
