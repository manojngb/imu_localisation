...
def run_sequence(scf, sequence):
    ...
    cf.commander.send_setpoint(0, 0, 0.75, 0)
    time.sleep(0.1)
    cf.commander.send_setpoint(0, 0, 0.4, 0)
    time.sleep(0.1)
    cf.commander.send_setpoint(0, 0, 0.3, 0)
    time.sleep(0.1)
    cf.commander.send_setpoint(0, 0, 0.2, 0)
    time.sleep(0.3)
    cf.commander.send_setpoint(0, 0, 0.1, 0)
    time.sleep(0.2)
